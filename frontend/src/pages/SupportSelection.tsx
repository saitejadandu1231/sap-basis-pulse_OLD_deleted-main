                          ...
                          {selectedConsultantObj.hourlyRate && selectedTimeSlots.length > 0 && (
                            <div className="mt-4 p-3 bg-primary/10 border border-primary/20 rounded-lg dark:bg-primary/5 dark:border-primary/10">
                              <div className="space-y-1">
                                ...
                                {/* Informational message about consultant changes */}
                                <div className="mt-3 p-2 bg-blue-50 border border-blue-200 rounded text-xs text-blue-800 dark:bg-blue-950/30 dark:border-blue-800 dark:text-blue-200">
                                  <div className="flex items-start">
                                    <svg className="w-3 h-3 mt-0.5 mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                      <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                    </svg>
                                    <span>
                                      <strong>Note:</strong> The final amount and hours may be adjusted by your consultant based on the actual work performed and complexity of your request.
                                    </span>
                                  </div>
                                </div>
                              </div>
