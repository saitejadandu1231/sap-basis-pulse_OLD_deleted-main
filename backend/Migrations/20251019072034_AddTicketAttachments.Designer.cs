...
namespace SapBasisPulse.Api.Migrations
{
    ...
    [Migration("20251019072034_AddTicketAttachments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SapBasisPulse.Api.Entities.DomainRestriction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SapBasisPulse.Api.Entities.SystemSetting", b =>
                {
            ...
            modelBuilder.Entity("SapBasisPulse.Api.Entities.TicketAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("UploadProvider")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("SapBasisPulse.Api.Entities.TicketNumberTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SequenceFormat")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.HasIndex("SupportTypeId", "SupportCategoryId", "SupportSubOptionId", "Priority", "IsActive");

                    b.ToTable("TicketNumberTemplates");
                });
            ...
            modelBuilder.Entity("SapBasisPulse.Api.Entities.DomainRestriction", b =>
                {
                    ...
                    b.HasOne("SapBasisPulse.Api.Entities.User", "UpdatedByUser")
                        .WithMany()
